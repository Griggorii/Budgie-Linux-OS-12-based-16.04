...
Скачать iso обновлённый Budgie-Linux-OS-12 пока нету iso . В настройках можно выбирать тему и поставить режим встроенная тема , диски образы iso img ntgthm не монтируются автоматом , а примонтировав надо будет зайти в приложение диски и там нажать на значёк  ▶ после этого вы увидите что диск примонтирован.
...
На убунте так же собирается хроме и хромиум OS http://rus-linux.net/nlib.php?name=/MyLDP/distr/chrome/chromeos.html , но есть 
такая вещь что в budgie лучше все это собирать и именно на этой системе потому что система легче и соответственно если все таки существует принцип наследования легкости системы в плане memory и легкости растягивания окошек то естественно эта ось 
лучшая.
